...
//n the above example, the user is prompted to enter an operator (either +, -, * or /) and two numbers.

// The parseFloat() converts the numeric string value to a floating-point value.

// The if...else if...if statement is used to check the condition that the user has entered for the opera
